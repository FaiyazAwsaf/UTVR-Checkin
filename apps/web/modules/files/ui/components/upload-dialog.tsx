...
export const UploadDialog = ({
  ...
  useEffect(() => {
    if (open && initialFilename) {
      setUploadForm((prev) => ({ ...prev, filename: initialFilename }));
    }
  ...
  return (
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>
            {initialFilename ? "Replace Document" : "Upload Document"}
          </DialogTitle>
          <DialogDescription>
            {initialFilename
              ? "Upload a revised file with the same name to replace its indexed content."
